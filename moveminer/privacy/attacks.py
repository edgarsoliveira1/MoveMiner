    ...
    def _risk(self, single_traj, traj, force_instances=False):
        ...
        if force_instances:
            ...
            for instance in instances:
                prob = 1.0 / traj.groupby().apply(lambda x: self._match(x, instance)).sum()
                elem_count = 1
...
class LocationAttack(Attack):
    ...
    def assess_risk(self, traj:Trajectory, targets=None, force_instances=False, show_progress=False):
